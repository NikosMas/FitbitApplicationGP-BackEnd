...
public class FitbitData {
	...
	static String access_token = FitbitToken.token();
...
///////////////////////////////////////////PROFILE//////////////////////////////////////////////////
	public String profile() throws JsonProcessingException, IOException {
		...
		headersGet.set("Authorization", "Bearer " + access_token);
		HttpEntity<String> entityGet = new HttpEntity<String>(headersGet);
		ResponseEntity<String> data = restTemplateGet.exchange(uriGet, HttpMethod.GET, entityGet, String.class);
